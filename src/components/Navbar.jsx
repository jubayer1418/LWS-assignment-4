...
function Navbar({ handleSearch }) {
  ...
  const { handleQuery } = useContext(NewsQuery);
        ...
        <div className="flex items-center space-x-3 lg:space-x-8">
          {show && (
            <input
              ...
              id="search-dropdown"
              className="z-20 block w-full bg-gray-200 px-4 py-2.5 pr-10 focus:outline-none rounded-[63px] placeholder:text-neutral-400 text-neutral-800"
              placeholder="Search"
              required
            />
          )}
